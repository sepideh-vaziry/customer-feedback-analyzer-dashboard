  ...
  return (
    <DashboardLayout>
      ...
      <div className="bg-bg-card rounded-2xl border border-border p-6 shadow-sm hover:shadow-md transition-shadow duration-300 mb-6">
        <h3 className="text-base font-bold text-text-primary mb-4">Feedback Volume</h3>
        {trends?.feedbackVolume?.labels?.length > 0 ? (
          <div className="h-64">
            <p className="text-sm text-text-muted font-medium">Volume data available for {trends.window}</p>
          </div>
        ) : (
      ...
      <div className="bg-bg-card rounded-2xl border border-border p-6 shadow-sm hover:shadow-md transition-shadow duration-300">
        <h3 className="text-base font-bold text-text-primary mb-4">Emerging Risk Patterns</h3>
        {riskTrends.length === 0 ? (
